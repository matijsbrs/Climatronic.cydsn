...
typedef struct interface_s {
    ...
    struct System_s {
        ...
        uint16_t HighAirFlowShort;   // @20 Duration of short increased flow override
        uint16_t HighAirFlowMedium;  // @21 Duration of medium increased airflow override
        uint16_t HighAirFlowLong;    // @22 Duration of long increased airflow override
